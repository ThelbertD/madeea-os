...
<style>
  body { margin: 0; background: #09141f; color: #f4f4f5; font-family: 'Inter', system-ui, sans-serif; }
  #stage { position: relative; width: 1920px; height: 1080px; overflow: hidden;
    background: linear-gradient(135deg, #09141f, #1c3247); }
  ...
  .title p { font-size: 32px; color: #fd5812; }
</style>
</head>
<body>
...
It exposes window.FX with deterministic helpers (call them while building the timeline):
  ...
  FX.ring(tl, "#scene", at, "#fd5812")                    → shockwave ring on the biggest beat
