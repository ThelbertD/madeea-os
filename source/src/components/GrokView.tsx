  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex items-center gap-3 mb-3 shrink-0">
        <div className="w-8 h-8 rounded-lg grid place-items-center text-[#09141f] font-bold text-[12px]" style={{ background: "linear-gradient(135deg,#eef0fb,#9ea2c4)" }}>Gb</div>
        <div>
        ...
        <div className="panel flex flex-col min-h-0 flex-1 p-0 overflow-hidden">
          ...
          <div className="border-t border-[var(--line-soft)] p-3 flex items-end gap-2 shrink-0">
            ...
            {streaming
              ...
              : <button onClick={send} disabled={!input.trim()} className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl text-[13px] font-semibold disabled:opacity-40" style={{ background: ACCENT, color: "#09141f" }}><Send size={14} /> Send</button>}
