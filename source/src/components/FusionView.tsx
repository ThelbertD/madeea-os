...
const ACCENT = "#fd5812"; // Fusion gold
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex items-center gap-3 mb-3 shrink-0">
        <div className="w-8 h-8 rounded-lg grid place-items-center text-[#1a130a] font-bold" style={{ background: "linear-gradient(135deg,#ff7a42,#c4400a)" }}><Network size={16} /></div>
        <div>
                ...
                <div className="max-w-[88%] w-full rounded-xl px-4 py-3.5" style={{ background: "var(--bg-card)", border: `1px solid ${ACCENT}40` }}>
                  {!partial ? (
                    <div>
                      ...
                      {/* progress shimmer */}
                      <div className="h-1 rounded-full overflow-hidden" style={{ background: "rgba(244, 244, 245,0.06)" }}>
