...
const NAV: NavItem[] = [
  ...
  { href: "/paperclip", label: "Paperclip", icon: <Building2 size={16} />, accent: "#fd5812", dim: "rgba(253, 88, 18,0.16)" },
...
const AGENT_ROUTES = new Set(["/claude", "/openclaw", "/hermes", "/antigravity", "/codex", "/kimi", "/glm", "/grok", "/freeclaude", "/omniroute", "/hy3-coder", "/fusion", "/sakana", "/local"]);
  ...
  return (
    <aside className="hidden md:flex flex-col w-[244px] shrink-0 h-screen overflow-hidden py-6 border-r border-[var(--line-soft)]"
      ...
      <Link href="/" prefetch={false} className="block mb-7 px-5 shrink-0">
        ...
        {/* Wordmark: "MadeEA" in the brand display serif, "OS" in the hand
            script, which picks up --gold (MadeEA orange) from the .hand rule. */}
        <div className="text-xl tracking-tight" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 700, color: "var(--cream)" }}>
          MadeEA <span className="hand text-[1.3em] ml-1">OS</span>
        </div>
        {version && (
      ...
      <div className="px-5 pb-1.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            style={{ color: customize ? "var(--gold)" : "var(--cream-dim)", background: customize ? "rgba(253, 88, 18,0.14)" : "transparent" }}
          >
              ...
              {customize ? (
                <div
                  ...
                  style={{
                    ...
                    background: isOver ? "rgba(253, 88, 18,0.08)" : "transparent",
                  }}
                >
