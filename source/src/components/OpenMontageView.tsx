      ...
      <div className="rounded-2xl p-5 mb-7"
        ...
        <div className="flex items-center justify-between gap-3 mt-3">
          ...
          <button onClick={generate} disabled={busy || prompt.trim().length < 4}
            ...
            style={{ background: busy ? "var(--bg-elev)" : `linear-gradient(135deg, ${ACCENT}, #ff7a42)`, color: busy ? "var(--cream-dim)" : "#1a1320", cursor: busy ? "default" : "pointer" }}>
        ...
        {busy && job && (
          <div className="mt-4">
            <div className="h-2 rounded-full overflow-hidden" style={{ background: "var(--bg-deep)" }}>
              <div className="h-full rounded-full transition-all" style={{ width: `${job.progress || 4}%`, background: `linear-gradient(90deg, ${ACCENT}, #ff7a42)` }} />
            </div>
